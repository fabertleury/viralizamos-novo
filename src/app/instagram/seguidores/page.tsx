  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 py-12">
                    ...
                    {services.map((service, index) => (
                      ...
                      >
                        ...
                        <div className="flex-grow flex flex-col">
                          ...
                          {isServiceSelected(service.id) && (
                            <Link 
                              href={`/checkout/instagram-v2/seguidores/step1?service_id=${service.id}&quantity=${selectedServices[service.id]}`}
        ...
        {/* Seção de informações e instruções */}
        <div className="container mx-auto px-4 md:px-8 lg:px-12 mt-16">
          <div className="bg-white rounded-xl shadow-md p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Informações Importantes</h3>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="mb-8">
                ...
                <ol className="list-decimal pl-5 space-y-3">
                  <li className="text-gray-700">Selecione o serviço de seguidores do seu interesse.</li>
                  <li className="text-gray-700">Informe o nome de usuário do seu perfil sem o @.</li>
                  <li className="text-gray-700">Vamos fazer uma busca pelo perfil e confirmar os detalhes.</li>
                  <li className="text-gray-700">Clique em (Turbinar) para finalizar o pedido.</li>
                </ol>
              </div>
              
              {/* Aviso especial para seguidores */}
              <div className="p-6 bg-red-50 rounded-lg border-l-4 border-red-400">
                <h4 className="text-lg font-semibold text-red-800 mb-3">⚠️ Aviso importante sobre pedidos de seguidores</h4>
                <p className="text-gray-700 mb-3">
                  Aguarde a conclusão de um serviço de seguidores antes de solicitar outro. Por exemplo, se você iniciar um serviço com 1000 seguidores e depois comprar mais 1000 sem esperar o primeiro ser concluído, ambos os serviços podem registrar o início em 1000 e a conclusão em 2000, resultando em erro na contagem.
                </p>
                <p className="text-gray-700 mb-3">
                  Esse é apenas um exemplo, válido para todos os pacotes. Para evitar problemas e garantir a entrega correta, evite fazer pedidos duplicados antes de um serviço ser finalizado.
                </p>
                <p className="text-gray-700 font-semibold">
                  Não haverá reembolso em caso de falta de seguidores devido a pedidos sobrepostos.
                </p>
              </div>
            </div>
          </div>
